...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :data-side="side"
      :class="cn(
        'bg-popover text-popover-foreground fixed z-50 flex flex-col gap-4 bg-clip-padding text-sm shadow-xl',
        ...
        'data-[side=bottom]:data-[state=open]:slide-in-from-bottom-8 data-[side=bottom]:data-[state=closed]:slide-out-to-bottom-8',
        'data-[side=left]:data-[state=open]:slide-in-from-left-8 data-[side=left]:data-[state=closed]:slide-out-to-left-8',
        'data-[side=right]:data-[state=open]:slide-in-from-right-8 data-[side=right]:data-[state=closed]:slide-out-to-right-8',
        'data-[side=top]:data-[state=open]:slide-in-from-top-8 data-[side=top]:data-[state=closed]:slide-out-to-top-8',
