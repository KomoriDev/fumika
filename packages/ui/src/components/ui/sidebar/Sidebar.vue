...
<template>
  ...
  >
    <div
      ...
      :class="cn(
        'transition-[width] duration-[180ms] ease-[cubic-bezier(0.16,1,0.3,1)] relative w-(--sidebar-width) bg-transparent',
    ...
    <div
      ...
      :data-side="side"
      :class="cn(
        'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-[180ms] ease-[cubic-bezier(0.16,1,0.3,1)] md:flex',
        side === 'left'
